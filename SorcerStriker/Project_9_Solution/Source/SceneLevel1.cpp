...
/*	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 0, -4000, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 50, -4000, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 100, -4000, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 150, -4000, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 200, -4000, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 250, -4000, 0);

	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 0, -4300, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 50, -4300, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 100, -4300, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 150, -4300, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 200, -4300, 0);
	App->enemies->AddEnemy(Enemy_Type::REDBIRD, 250, -4300, 0);

	App->enemies->AddEnemy(Enemy_Type::BROWNSHIP, 100, -4250, 0);
	App->enemies->AddEnemy(Enemy_Type::BROWNSHIP, 150, -4250, 0);
	
	App->enemies->AddEnemy(Enemy_Type::BROWNSHIP, 0, -4150, 0);
	App->enemies->AddEnemy(Enemy_Type::BROWNSHIP, 50, -4150, 0);
	
	App->enemies->AddEnemy(Enemy_Type::BROWNSHIP, 150, -4150, 0);
